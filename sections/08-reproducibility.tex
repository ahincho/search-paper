...
Artículo & \texttt{ahincho/search-article} & Este documento \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Paper: \url{https://github.com/ahincho/search-article}
\end{itemize}
...
git clone https://github.com/ahincho/search-article
cd search-article
